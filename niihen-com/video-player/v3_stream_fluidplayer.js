$(document).ready(function(){
    ...
    $('#ListServer0').html( ' <button id="ServDef">Server Default</button> ' );    			
		    $("#ServDef").click(function(){	
		      $('#streamingframe').attr("src", "https://pitou77.github.io/mycustomvideoplayer.github.io/?jd1="+defaultJudul+"&vp1="+Perawanin+"&cv1="+defaultCoverURL);
		    });
	  });
    ...
    $('#ListServer1').html( ' <button id="ServAlt">Server Alternatif</button> ' );    			
		    $("#ServAlt").click(function(){	
		      $('#streamingframe').attr("src", "https://pitou77.github.io/mycustomvideoplayer.github.io/?jd1="+defaultJudul+"&vp1="+Perawanin2+"&cv1="+defaultCoverURL);
		    });
	  });
    ...
    $('#ListServer2').html( ' <button id="ServAmn">Server Aman</button> ' );    			
		    ...
		    $('#streamingframe').attr("src", "https://pitou77.github.io/mycustomvideoplayer.github.io/?jd1="+defaultJudul+"&vp1="+Perawanin3+"&cv1="+defaultCoverURL);
		  });
	  });
});     
